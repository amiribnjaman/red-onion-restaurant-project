...
const AboutCard = ({ AboutImg, IconImg }) => {
    return (
        <div>
            <div>
                <div class="max-w-sm mt-16 bg-white rounded-2xl border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
                    <a href="#">
                        <img class="rounded-t-lg" src={AboutImg} alt="" />
                    </a>
