                ...
                <div class="container flex flex-wrap justify-between items-center mx-auto">
                    ...
                    <div class="hidden w-full md:block md:w-auto" id="mobile-menu">
                        <ul class="flex flex-col mt-4 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium items-center">
                            <li>
                                <Link to="/" class="block py-2 text-base pr-4 pl-3 text-black rounded md:bg-transparent md:text-black md:p-0 dark:text-white" aria-current="page">
                                    <FontAwesomeIcon icon={faCartShopping} />
                                </Link>
                            </li>
                            <li>
                                <Link to="/" class="block py-2 pr-4 pl-3 text-black rounded md:bg-transparent md:text-black md:p-0 dark:text-white" aria-current="page">
                                    Login
                                </Link>
                            </li>
                            <li>
                                <Link to="/" class="block py-2 pr-4 pl-3 text-base text-white rounded md:bg-transparent md:text-black md:p-0 dark:text-white" aria-current="page">
