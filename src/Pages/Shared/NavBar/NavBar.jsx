...
const NavBar = () => {
    return (
        <div>
            <nav className="bg-white w-11/12 mx-auto border-gray-200 px-2 sm:px-4 py-8 rounded dark:bg-gray-800">
                <div className="container flex flex-wrap justify-between items-center mx-auto">
                    ...
                    <div className="hidden w-full md:block md:w-auto" id="mobile-menu">
                        <ul className="flex flex-col mt-4 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium items-center">
                            <li>
                                <Link to="/" className="block py-2 text-base pr-4 pl-3 text-black rounded md:bg-transparent md:text-black md:p-0 dark:text-white" aria-current="page">
